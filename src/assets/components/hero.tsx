...
export function Hero() {
 ...
 <button  className="flex flex-row gap-2 items-center bg-gray-600 py-2 px-4 cursor-not-allowed text-bandit-text p-4 m-2 rounded-md md:text-2xl lg:text-3xl">
                COMING SOON
