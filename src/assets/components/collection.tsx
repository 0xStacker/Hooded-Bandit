export function Collection() {
    return (
        <>
        <p className="text-3xl text-bandit-orange font-bandit text-center m-4">THE COLLECTION</p>
        ...
        <div className=" flex flex-col  m-8 border-solid border border-hood-purple inset-shadow-sm inset-shadow-violet-700/50 gap-2 rounded-md p-4 gap-2 font-bandit text-bandit-text md:grid grid-cols-4 lg:grid grid-cols-4">
            <div className="flex flex-col border border-solid border-hood-purple items-center border-r-solid border-r border-r-hood-purple px-8 py-2 rounded-md">
                <div className="flex flex-row gap-2">
                    <svg version="1.1" id="_x32_" xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 512 512" fill="#000000" className="fill-hood-purple w-14"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <style type="text/css"></style> <g> <polygon points="509.344,159.094 509.344,159.078 428.906,76.625 375.906,159.094 "></polygon> <polygon points="188.531,192.547 256,445.063 323.484,192.547 "></polygon> <polygon points="198.953,159.094 312.453,159.094 312.453,159.078 254.797,79.625 198.953,159.078 "></polygon> <polygon points="344.422,146.188 395.375,66.938 286.906,66.938 344.406,146.188 "></polygon> <polygon points="222.844,66.938 116.625,66.938 167.375,145.844 "></polygon> <polygon points="83.094,76.625 2.656,159.078 2.656,159.094 136.125,159.094 "></polygon> <polygon points="0,192.547 220.313,441.094 220.328,441.125 153.906,192.547 "></polygon> <polygon points="358.094,192.547 291.688,441.125 291.703,441.094 512,192.547 "></polygon> </g> </g></svg>
                    <p className="text-3xl text-hood-purple">3333</p>
                </div>
            ...
            <div className="flex flex-col border border-solid border-hood-purple items-center border-r-solid border-r border-r-hood-purple px-8 py-2 rounded-md">
             ...
             <div className="flex flex-col border border-solid border-hood-purple items-center border-r-solid border-r border-r-hood-purple px-8 py-2 rounded-md">
                <div className="flex flex-row gap-2">
                   <svg className="w-14" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path d="M12 20V17.6M12 6.4V4M20 12H17.6M6.4 12H4M17.6569 6.34315L15.9598 8.0402M8.0402 15.9598L6.34315 17.6569M6.34293 6.34332L8.03999 8.04038M15.9596 15.96L17.6566 17.657" stroke="#7b4bb7" stroke-width="1.5" stroke-linecap="round"></path> </g></svg>
                   <p className="text-3xl text-hood-purple">PFP</p>
                </div>
